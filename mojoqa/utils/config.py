...
class Config:
    ...
    def __init__(self, data, llama_embedding_model, document_splitter, llama_model):
        """
    ...
    def from_json(cls, cfg):
        ...
        return cls(params.data, params.llama_embedding_model, params.document_splitter, params.llama_model)
