...
class Config:
    ...
    def __init__(self, path, llama_embedding_model, llama_model, document_splitter):
        """
    ...
    def from_json(cls, cfg):
        ...
        return cls(params.path, params.llama_embedding_model, params.llama_model, params.document_splitter)
